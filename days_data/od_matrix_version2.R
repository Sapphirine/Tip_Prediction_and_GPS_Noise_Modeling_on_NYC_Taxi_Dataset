...
region5 <- function(px, py) {
  return(
    ifelse( px < -4000 & 31000 < py & py < 45000, 1, 0)
  )
}

region6 <- function(px, py) {
  return(
    ifelse( -4000 < px & px < -1300 & 31000 < py & py < 45000, 1, 0)
  )
}

region7 <- function(px, py) {
  return(
    ifelse( -1300 < px & px <  1300 & 31000 < py & py < 45000, 1, 0)
  )
}

region8 <- function(px, py) {
  return(
    ifelse( 1300 < px & 31000 < py & py < 45000, 1, 0)
  )
}
...
weekend_sample %>% filter(  -6500 < px & px <  3500 &  18000 < py & py <  57000) %>%  ## px(-6500, -4000, -1500, 1000, 3500); py(18000, 24500, 31000, 37500, 44000, 50500, 57000)
